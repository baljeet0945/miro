 <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                ...
                <a class="btn btn-success btn-sm" href="https://miro.com/sso/login/?email=<?= $_SESSION['user']['result']['username'].'@'.DOMAIN_NAME?>" target="blank">Login Miro</a>
            </div>
